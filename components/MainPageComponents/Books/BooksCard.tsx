    ...
    return(
        <div className="card bg-neutral-800/50 w-80 shadow-sm">
            ...
            <div className="card-body">
                <h2 className="card-title mb-6">{props.book.m_title}</h2>
                ...
                <div className="*:m-1 bg-black/10 flex flex-wrap gap-1 rounded-2xl">
                    ...
                    <div className="badge w-fit">
                        {props.book.name}
                        <div className="w-fit p-1 text-white/10">{props.book.dept}</div>    
                        <div className="w-fit p-1 text-white/10">{props.book.batch}</div>
                    </div>
                </div>
