...
export default function NotesFilter(){
    ...
    const [teachers, setTeachers] = useState<Array<string>>([]);
    ...
    return(
        <div className={`bg-neutral-900 p-1 rounded-3xl`}>
            <div className="filter">
                ...
                onChange={()=>{setCoursesSelected(false);setTeachersSelected(false);}}/>
                ...
                onChange={()=>{setCoursesSelected(true);setTeachersSelected(false);}}/>
                <input className="btn text-xs bg-cyan-950 w-fit p-1 rounded-xl" type="radio" name="metaframeworks" aria-label="Teachers"
                onChange={()=>{setCoursesSelected(false);setTeachersSelected(true);}}/>
            </div>
