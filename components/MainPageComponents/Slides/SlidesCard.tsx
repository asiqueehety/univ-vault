    ...
    return(
        <div className="card bg-neutral-800/50 w-full sm:w-80 shadow-sm">
            ...
            <div className="card-body p-4 sm:p-6">
                <h2 className="card-title mb-4 sm:mb-6 text-base sm:text-lg">{props.slide.m_title}</h2>
                ...
                <div className="*:m-1 bg-black/10 flex flex-wrap gap-1 rounded-2xl p-2">
                    <div className="w-fit *:ml-1">
                        <div className="text-sm sm:text-base">{props.slide.t_name}</div>
                ...
                <div className="*:m-1 bg-black/10 flex flex-wrap gap-1 rounded-2xl p-2">
                    ...
                    <div className="badge w-fit flex-wrap sm:flex-nowrap">
                        <span className="text-xs sm:text-sm">{props.slide.name}</span>
                        <div className="w-fit p-1 text-xs text-white/10">{props.slide.dept}</div>    
                        <div className="w-fit p-1 text-xs text-white/10">{props.slide.batch}</div>
                    </div>
                </div>
                <div className="card-actions justify-end mt-2">
                    <button className="btn btn-ghost btn-sm sm:btn-md" title="Preview">
                    ...
                    onClick={() => {
                        ...
                        link.href = props.slide.file_location;
                        link.download = props.slide.m_title; // optional: default file name
                        link.click();
                    }}
                    >
