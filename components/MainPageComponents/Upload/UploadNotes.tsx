...
export default function UploadNotes(){
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await fetch('https://server-univ-vault.onrender.com/upload/materials', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    return(
        <div className="p-2 sm:p-4">
            <fieldset className="fieldset bg-black/20 border-base-300 rounded-box w-full max-w-xl *:w-full border p-3 sm:p-4 mx-auto my-auto">
                <legend className="fieldset-legend text-xl sm:text-2xl lg:text-3xl">Contribute a Note</legend>
