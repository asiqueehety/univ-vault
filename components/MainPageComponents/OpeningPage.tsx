    ...
    return(
        ...
        <div className="tabs tabs-border justify-center">
            ...
            <div className="fab">
                ...
                <div>Notes<Link href="./Upload/Notes.tsx" className="btn btn-lg btn-circle">
                ...
                <div>Slides<button className="btn btn-lg btn-circle">
                ...
                <div>Question Papers<button className="btn btn-lg btn-circle">
                ...
                <div>Books<button className="btn btn-lg btn-circle">
