...
export default function EditMaterial(
    ...
    const [description, setDescription] = useState(m_description);
    const [file, setFile] = useState<File | null>(file_location ? null : null);
    const [fileURL, setFileURL] = useState(file_location || "");
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await fetch('https://server-univ-vault.onrender.com/edit/materials', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    return(
        <div>
            <fieldset className="fieldset bg-black border-base-300 rounded-box w-xl *:w-xl border p-4 mx-auto my-auto">
                <legend className="fieldset-legend text-3xl">Edit {m_type}</legend>
                ...
                <fieldset className="fieldset">
                    <legend className="fieldset-legend">Edit Department of the course</legend>
                    <div className="flex-1">
                        <select defaultValue="Edit department" className="select"
                        onChange={(e) => {
                        ...
                        >
                            <option disabled={true}>Edit department</option>
                ...
                <fieldset className="fieldset">
                    ...
                    <div className="flex flex-1">
                        <select
                            ...
                            >
                            <option value="" disabled>{c_name}</option>
